...
export default function ModuleManagement() {
  ...
  const optionalModules = [
    { id: 'finance', name: 'Financeiro Completo', description: 'Contas a pagar, receber e fluxo de caixa.', icon: DollarSign, active: true },
    { id: 'routes', name: 'Otimização de Rotas', description: 'Planejamento e acompanhamento de entregas.', icon: Truck, active: false },
    { id: 'bi', name: 'BI Avançado', description: 'Dashboards e relatórios de inteligência de negócio.', icon: LineChart, active: false },
    { id: 'automation', name: 'Automação com IA', description: 'Sugestões de compra e otimizações automáticas.', icon: Bot, active: false },
  ];
            ...
            {optionalModules.map((module) => (
              <div key={module.id} className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <Switch id={`module-${module.id}`} defaultChecked={module.active} />
                </div>
              </div>
            ))}
          </CardContent>
