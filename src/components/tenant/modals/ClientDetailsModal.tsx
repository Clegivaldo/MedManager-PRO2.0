    ...
    <DialogContent className="max-w-3xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
        <div className="space-y-4">
            <InfoItem icon={FileText} label="CNPJ" value={client.cnpj} />
            <InfoItem icon={Mail} label="Email de Contato" value={client.contact} />
        </div>
        <div className="space-y-4">
            <InfoItem icon={Phone} label="Telefone" value={client.phone} />
            <InfoItem icon={MapPin} label="Localização" value={`${client.city}, ${client.state}`} />
        </div>
      </div>
      <div>
