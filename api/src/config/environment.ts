...
const envSchema = z.object({
  ...
  RATE_LIMIT_TENANT_WINDOW_MS: z.string().default('60000'),
  RATE_LIMIT_TENANT_MAX_REQUESTS: z.string().default('1000'),
...
export const config = {
  ...
  RATE_LIMIT_TENANT_WINDOW_MS: parseInt(env.RATE_LIMIT_TENANT_WINDOW_MS),
  RATE_LIMIT_TENANT_MAX_REQUESTS: parseInt(env.RATE_LIMIT_TENANT_MAX_REQUESTS),
