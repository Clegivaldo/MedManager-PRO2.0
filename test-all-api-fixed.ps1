# ðŸ§ª SUITE DE TESTES - MedManager PRO 2.0
...
function Test-Endpoint {
    ...
    try {
        ...
        Write-Host " âŒ FALHOU" -ForegroundColor Red
...
Write-Host ""
Write-Host "=== FASE 2: AUTENTICAÃ‡ÃƒO ===" -ForegroundColor Yellow
Write-Host ""
...
if ($loginResult.success) {
    ...
    Write-Host ""
    Write-Host "=== FASE 3: GESTÃƒO DE TENANTS ===" -ForegroundColor Yellow
    Write-Host ""
    ...
    $newTenant = @{
        name = "FarmÃ¡cia Teste AutomÃ¡tico"
        cnpj = "12345678000195"
        plan = "starter"
    }
    ...
    if ($result.success) {
        ...
        Write-Host ""
        Write-Host "=== FASE 4: GESTÃƒO DE PLANOS ===" -ForegroundColor Yellow
        Write-Host ""
        ...
        Write-Host ""
        Write-Host "=== FASE 5: GESTÃƒO DE MÃ“DULOS ===" -ForegroundColor Yellow
        Write-Host ""
        
        # 7. Listar MÃ³dulos do Tenant
        $result = Test-Endpoint -Name "Listar MÃ³dulos" -Method "GET" -Url "$baseUrl/superadmin/modules/$tenantId" -Headers $headers
        $results += $result
        ...
        $result = Test-Endpoint -Name "Habilitar MÃ³dulos" -Method "PUT" -Url "$baseUrl/superadmin/modules/$tenantId" -Headers $headers -Body $moduleBody
        $results += $result
